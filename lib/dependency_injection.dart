...
import 'package:dufs/core/common/data_source_impls/keep_user_data_source_impl.dart';
import 'package:dufs/core/common/data_sources/keep_user_data_source.dart';
import 'package:dufs/feature/domain/use_cases/auth/is_sign_in_use_case.dart';
import 'package:dufs/feature/domain/use_cases/auth/sign_in_with_biometric_use_case.dart';
import 'package:dufs/feature/domain/use_cases/auth/sign_out_use_case.dart';
import 'package:dufs/feature/domain/use_cases/user/user_backup_use_case.dart';
import 'package:dufs/feature/domain/use_cases/user/user_remove_use_case.dart';
...
Future<void> init() async {
  ...
  locator.registerFactory<MapCubit>(() => MapCubit(
        geolocatorService: locator(),
        placesService: locator(),
      ));
  ...
  locator.registerLazySingleton<MarkerService>(() => MarkerService());
